##############################################################################
#   a122_catch_a_turtle_leaderboard_solution.py 
#   Example Solution:
#     The complete game code including a leaderboard that maintains
#     the top 5 scorers
##############################################################################
#-----import statements-----
...
# TODO 2: add leaderboard variables
leaderboard_file_name = "Unit_1.2/1.2.2/a122_leaderboard.txt"
leader_names_list = []
leader_scores_list = []
...
def manage_leaderboard():
  ...
  # load all the leaderboard records into the two lists leader_names_list and leader_scores_list
